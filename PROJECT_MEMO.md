...
3. **Firebase لا يوفر رمز OTP رقميًا عبر البريد لتسجيل دخول الويب**
   ...
   - الحالة: الكود والواجهة مكتملان محليًا، وتحقق الفحص المرئي من تفعيل موفر Email Link في Firebase Console؛ بقي الاختبار الفعلي بعد النشر.
...
- عامل TOTP مضاف إلى حساب المالك، بينما فرض MFA العام ما زال معطلًا عمدًا لمنع قفل الحساب قبل اختبار دخول جديد.
...
- اختبار إرسال رابط إلى بريد المالك بعد النشر وإكماله مع تحدي TOTP.
- بعد النشر: تسجيل خروج ودخول إنتاجي بكلمة المرور ورمز Authenticator، ثم توثيق النجاح قبل فرض MFA تدريجيًا.
