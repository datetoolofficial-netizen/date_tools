...
الإصدار الحالي للتطبيق هو 0.3.37.
نسخة منصة الإدارة الحالية هي 0.1.41.
...
3. **اتساع تحديثات Firestore للمساعدين والحملات**
   ...
   - الحالة: محلول محليًا؛ نشر قواعد Firestore يحتاج موافقة إنتاج صريحة منفصلة.
...
- لم تُنشر قواعد Firestore بعد لأن تغيير حاجز صلاحيات قاعدة الإنتاج يحتاج موافقة صريحة منفصلة بعد عرض أثره.
