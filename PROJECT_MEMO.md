...
### نشر 0.3.61 وفحص الأمان وGoogle - جارٍ
...
1. **ثلاثة تنبيهات مرتفعة من CodeQL في فحص ما بعد النشر**
   ...
   - الحالة: أغلق CodeQL التنبيهين الأولين؛ التنبيه الثالث محلول محليًا وينتظر الدفع وإعادة الفحص.
...
3. **بوابة الجودة الكاملة لم تكتمل بسبب اتصال npm**
   - الأعراض: فشل `npm run quality:local` مرتين في خطوة audit فقط برسالة `ECONNRESET`.
   - السبب: انقطاع اتصال مؤقت بواجهة سجل npm.
   - الحل: نُفذ فحص الاعتماديات نفسه مستقلًا ونجح بلا ثغرات، ونجحت بقية الفحوص مستقلة. تعاد البوابة الكاملة أو يعتمد GitHub Quality Gate بعد دفع الإصلاح.
   - الحالة: مانع شبكة خارجي لا يدل على فشل برمجي.
...
- دفع إصلاح تنبيه CodeQL الثالث والتوثيق، ثم التحقق من عدم بقاء تنبيهات مفتوحة ونجاح Quality Gate.
