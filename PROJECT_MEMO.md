...
1. **الأدوار الإدارية القديمة كانت واسعة ولا تميز مالك المنصة**
   ...
   - الحالة: محلول في الكود محليًا، وتم تعيين حساب المالك الحالي في Firebase.
...
3. **صلاحية تعليق المدير كان يمكن أن تتداخل مع تعديل دوره عبر طلب مباشر**
   ...
   - الحالة: محلول محليًا ومغطى باختبار ثابت.
...
4. **لم يكن هناك سجل مركزي غير قابل للتلاعب للعمليات الحساسة**
   ...
   - الحالة: محلول محليًا، ويبدأ جمع السجل بعد نشر التطبيق والقواعد.
...
- الكود وقواعد Firestore لم تُنشر، ولم يتغير رقم الإصدار؛ تغيير الإنتاج الوحيد هو إضافة حقل دور المالك إلى حساب الإدارة الحالي بعد موافقة المستخدم.
- يلزم عند قرار النشر نشر التطبيق وقواعد Firestore معًا حتى تصبح صفحات الفريق وسجل العمليات والصلاحيات الجديدة فعالة في المنصة الأساسية.
