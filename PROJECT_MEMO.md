...
الإصدار الحالي للتطبيق هو 0.3.33.
نسخة منصة الإدارة الحالية هي 0.1.35.
...
- نجحت اختبارات Vitest وESLint وبناء Next.js قبل تثبيت رقم النسخة، ويعاد تشغيلها على الحالة النهائية قبل النشر.
...
- المتبقي: تشغيل الفحوص النهائية، إنشاء الكومت، دفعه إلى `origin/master`، نشر Worker `datetools`، ثم فحص النسخة الحية وتسجيل معرف النشر هنا.
