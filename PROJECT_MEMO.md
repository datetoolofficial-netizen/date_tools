...
- التغييرات مكتملة محليًا ومجهزة ضمن الإصدار `0.3.62`، وبوابة الجودة خضراء.
- الإصدار المنشور ما زال `0.3.61` حتى اكتمال الدفع والنشر والتحقق الإنتاجي.

المتبقي المحفوظ:

- دفع الإصدار `0.3.62`، مراقبة بوابة GitHub والنشر، ثم اختبار تسجيل الدخول الحقيقي بواسطة المستخدم دون كشف كلمة المرور.
